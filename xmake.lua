local project_name = "rthybrid-hindmarsh-rose-1984-neuron"
...
local rtsyn_modules = {
    { path = "rthybrid_hindmarsh_rose_1984_neuron", name = "rthybrid_hindmarsh_rose_1984_neuron", link_plugin = true },
